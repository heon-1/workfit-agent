...
class AiProcessor(BaseProcessor):
    ...
    def _build_prompt(self, title: str, content: str) -> str:
        ...
        prompt = f"다음 뉴스 기사의 제목과 내용을 분석하여, 독자의 흥미를 유발하고 계속 주목하게 만들 수 있는 핵심적인 '도파민 포인트'를 3가지 이하로 추출해줘. 각 포인트는 간결하게 설명하고, 번호 목록 형식(예: '1. 내용')으로 답변해줘.\n\n제목: {title}\n\n내용 요약:\n{content[:1500]}... \n\n도파민 포인트 목록:" # 내용 길이 제한 조정 (1500자)
        return prompt
